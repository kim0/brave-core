...
std::unique<TranslateBubbleView>
TranslateBubbleController::MakeTranslateBubbleView(Args&&... args) {
  ...
  return new std::make_unique<TranslateBubbleView>(std::forward<Args>(args)...);
}
